...
use tool_etl\processor\processor_lowercase;
use tool_etl\logger;

defined('MOODLE_INTERNAL') || die;


class tool_etl_processor_lowercase_testcase extends advanced_testcase {
    /**
     * @var source_fake
     */
    protected $source;
    ...
    public function test_no_settings_exist() {
        $processor = new processor_lowercase();
    ...
    public function test_short_name() {
        $processor = new processor_lowercase();
        $this->assertEquals('processor_lowercase', $processor->get_short_name());
    }

    public function test_config_form_prefix() {
        $processor = new processor_lowercase();
        $this->assertEquals('processor_lowercase-', $processor->get_config_form_prefix());
    }
